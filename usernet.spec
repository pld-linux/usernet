...
Narzędzie usernet daje graficzny inferfejs do manipulowania
interfejsami sieciowymi (podnoszenia, wyłączania, sprawdzania
statusu). Użytkownicy mogą manipulować tylko interfejsami
kontrolowanymi przez użytkowników. Administator może kontrolować
wszystkie.
